...
namespace backend.Services.IServices
{
    public interface IUserService
    {
        ...
        Task<UserOperationResponseDto> CreateUserAsync(CreateUserDto createUserDto, IFormFile? pictureFile = null);
        Task<UserOperationResponseDto> UpdateUserAsync(int id, UpdateUserDto updateUserDto, IFormFile? pictureFile = null);
